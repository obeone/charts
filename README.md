...
| :-: | --- | --- | --- |
| 🕵️ | [**cloakbrowser-mcp**](charts/cloakbrowser-mcp) | `1.13.0` | [CloakBrowser MCP](https://github.com/swimmwatch/cloakbrowser-mcp) — Playwright browser-automation MCP server over HTTP, backed by a stealth Chromium. |
...
| 🔥 | [**firecrawl**](charts/firecrawl) | `2.11.376` | [Firecrawl](https://github.com/firecrawl/firecrawl) — crawl & scrape sites into LLM-ready data (markdown, HTML, JSON). Self-hosted API, workers & Playwright. |
