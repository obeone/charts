...
| :-: | --- | --- | --- |
| 🕵️ | [**cloakbrowser-mcp**](charts/cloakbrowser-mcp) | `1.14.0` | [CloakBrowser MCP](https://github.com/swimmwatch/cloakbrowser-mcp) — Playwright browser-automation MCP server over HTTP, backed by a stealth Chromium. |
| 🔪 | [**cyberchef**](charts/cyberchef) | `v11.4.0` | GCHQ's [Cyber Swiss Army Knife](https://github.com/gchq/CyberChef) — encode, decode, encrypt, analyze. Multi-arch. |
...
| 🔥 | [**firecrawl**](charts/firecrawl) | `2.11.403` | [Firecrawl](https://github.com/firecrawl/firecrawl) — crawl & scrape sites into LLM-ready data (markdown, HTML, JSON). Self-hosted API, workers & Playwright. |
...
| 🌐 | [**technitium-dnsserver**](charts/technitium-dnsserver) | `15.5.0` | [Technitium DNS Server](https://github.com/TechnitiumSoftware/DnsServer) — recursive / authoritative DNS, PiHole & AdGuard alternative. |
