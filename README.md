...
| 🔥 | [**firecrawl**](charts/firecrawl) | `2.11.162` | [Firecrawl](https://github.com/firecrawl/firecrawl) — crawl & scrape sites into LLM-ready data (markdown, HTML, JSON). Self-hosted API, workers & Playwright. |
